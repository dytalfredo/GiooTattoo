...
const SmokeEffect: React.FC<SmokeEffectProps> = ({ intensity = 'normal', theme = 'dark' }) => {
  ...
  return (
    <canvas 
      ref={canvasRef} 
      className={`fixed bottom-0 left-0 w-full h-full pointer-events-none z-30 transition-all duration-1000 ease-in-out ${
         theme === 'dark' ? 'mix-blend-screen' : 'mix-blend-multiply opacity-60'
